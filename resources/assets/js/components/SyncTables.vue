                ...
                <table class="table table-bordered" style="margin-bottom: 0;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ staff.rows }}</td>
                            <td height="47">
                                <button class="btn btn-info btn-sm" @click="updateStaff" v-if="locations.rows > 0 && credentials === 'valid'">
                        ...
                        <tr>
                            ...
                            <td>{{ students.rows }}</td>
                            <td height="47">
                                <button class="btn btn-info btn-sm" @click="updateStudents" v-if="locations.rows > 0 && credentials === 'valid'">
                        ...
                        <tr>
                            ...
                            <td>{{ courses.rows }}</td>
                            <td height="47">
                                <button class="btn btn-info btn-sm" @click="updateCourses" v-if="locations.rows > 0 && credentials === 'valid'">
                        ...
                        <tr>
                            ...
                            <td>{{ sections.rows }}</td>
                            <td height="47">
                                <button class="btn btn-info btn-sm" @click="updateSections" v-if="locations.rows > 0 && credentials === 'valid'">
                        ...
                        <tr>
                            ...
                            <td>{{ rosters.rows }}</td>
                            <td height="47">
                                <button class="btn btn-info btn-sm" @click="updateRosters" v-if="locations.rows > 0 && credentials === 'valid'">
